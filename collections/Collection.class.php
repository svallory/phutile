 ...
 * @version SVN: $Id$
 * @since 1.0
 * @package Neobase.system.collections
 */

require_once dirname(__FILE__) . '/../lang/PhpType.class.php';
...
class Collection implements Countable, ArrayAccess, Iterator {
	...
	/**
	 * 
	 * @param string $type The name of the type or the class
	 ...
	 * @return boolean
	 */
	public function removeAll($coll)
	{
		foreach($coll as $item)
		{
